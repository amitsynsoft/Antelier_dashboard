...
export function TopNav({
  ...
  return (
    ...
    >
      ...
      {/* Global Actions Only: Search, Help, Notifications, Theme */}
      <div className="flex items-center gap-2.5 sm:gap-3 ml-auto">
        {/* Global Command Search */}
        <button
          type="button"
          onClick={onOpenCommandPalette}
          className="group flex w-48 sm:w-64 md:w-80 cursor-pointer items-center justify-between rounded-xl border border-border/70 bg-muted/40 px-3.5 py-2 text-xs sm:text-sm text-muted-foreground shadow-2xs transition-all hover:bg-muted/70 hover:text-foreground"
        >
