...
export const PREDEFINED_INTEGRATIONS: {
...
}[] = [
  {
    ...
    description: "Create a new lead in HubSpot or Salesforce",
  },
  {
    type: "calendar",
    title: "Check Calendar",
    description: "Query calendar availability for open booking slots",
  },
  {
    type: "email",
    title: "Send Email",
    description: "Send automated email notification or welcome message",
  },
  {
    type: "whatsapp",
    title: "Send WhatsApp",
    description: "Dispatch instant WhatsApp chat message",
  },
  {
    type: "call",
    title: "Call Staff",
  ...
  // { type: "notification", title: "Notify Team", description: "Ping Slack channel or assign team member" },
  {
    type: "ticket",
    title: "Create Ticket",
    description: "Generate new support ticket in Hubspot",
  },
  // {
  //   type: "finance",
  //   title: "Route to Finance",
  //   description: "Route invoice/billing query to finance team",
  // },
  // {
  //   type: "webhook",
  //   title: "Trigger Webhook",
  //   description: "Send custom HTTP POST payload to external API",
  // },
  {
    type: "custom",
    title: "Run Custom Action",
    description: "Execute custom Javascript/python cloud function",
  },
]
